...
def escoger(opcion,dicc,dicc_clientes):
    print("\n")
    if opcion == 1:
        ...
        while ciclo != 4:
            ...
            menu_tarjetas()
            ciclo = escoger_tarjetas(validacion("Opcion 1 a 4: "), dicc)
...
ruta = "C:\\Users\\campus\\Documents\\python\\tarjetas.json"
ruta2 = "C:\\Users\\campus\\Documents\\python\\clientes.json"
while True:
  dicc_clientes = cargar_ruta(ruta2)
  dicc = cargar_ruta(ruta)
  input("\nPRESIONE CUALQUIER TECLA PARA CONTINUAR AL PROGRAMA MENU")
  menu()
  escoger(validacion("Opcion 1 a 4: "),dicc,dicc_clientes)
  print("\n")